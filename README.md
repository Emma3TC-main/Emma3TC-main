...
## About Me <img src="https://media.giphy.com/media/3o7aD2saalBwwftBIY/giphy.gif" width="35"/>
...
- ⚙️ Passionate about **System Architecture**, **Distributed Systems**, and **Cloud Computing**
- 🔐 Interested in **Cybersecurity**, **Networking**, and **Infrastructure**
- 🚀 Experience building scalable applications using **Java, Spring Boot, Node.js, Angular, React, Flutter, and Docker**
- 🧠 Strong analytical and mathematical background from the **International Baccalaureate (IB Diploma Programme)**
...
- Implemented features under **Clean Architecture**
- Integrated REST APIs with backend services
- Collaborated with business and technical teams to align requirements
